...
// Test NTT-friendly prime used by Corona
const (
	TestN uint32 = 256
...
func TestIsNTTPrime(t *testing.T) {
	...
	tests := []struct {
		...
		{256, 0x1000000004A01, true, "Corona Q"},
		{256, 0x40201, true, "Corona QXi"},   // 262657 - prime, ≡ 1 (mod 512)
		{256, 0x7FE01, true, "Corona QNu"},   // 523777 - prime, ≡ 1 (mod 512)
