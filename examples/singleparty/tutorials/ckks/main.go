...
func main() {
	...
	//
	// ======================================================
	// Capabilities of the CKKS Package in the Lattice Library
	// ======================================================
	//
	...
	// ==========
	//
	// In lattice, a type's methods are thread-safe and can be called concurrently. E.g. one can use an evaluator's methods concurrently.
	//
