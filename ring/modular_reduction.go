...
//
// Thin shim over github.com/luxfi/math/ntt/subring.
// LP-107 Phase 3 inverted the dependency: luxfi/math owns the
// Montgomery / Barrett body. This package re-exports it so
...
func MForm(a, q uint64, bredconstant [2]uint64) uint64 {
	return subring.MForm(a, q, bredconstant)
}
...
func MFormLazy(a, q uint64, bredconstant [2]uint64) uint64 {
	return subring.MFormLazy(a, q, bredconstant)
}
...
func IMForm(a, q, mredconstant uint64) uint64 {
	return subring.IMForm(a, q, mredconstant)
}
